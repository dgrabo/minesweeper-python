...
class Cell:
    ...
    def surrounded_cells(self):
        cells = [
            self.get_cell_byAxis(self.x - 1, self.y - 1),
            self.get_cell_byAxis(self.x - 1, self.y),
            self.get_cell_byAxis(self.x - 1, self.y + 1),
            self.get_cell_byAxis(self.x, self.y - 1),
            self.get_cell_byAxis(self.x + 1, self.y - 1),
            self.get_cell_byAxis(self.x + 1, self.y),
            self.get_cell_byAxis(self.x + 1, self.y + 1),
            self.get_cell_byAxis(self.x, self.y +1)
    ...
    def show_cell(self):
        if not self.is_opened:
            ...
            # configure  the bg color to SystemButtonFace
